  ...
  const pricingPlans = [
    {
      ...
      monthlyPrice: "Free",
      annualPrice: "Free",
      description: "Start earning data dividends with basic features.",
      features: [
        "Up to 10 data sales per month",
        "Basic consent management",
        "Standard $DATA token rewards",
        "Lighthouse receipt storage",
        "Community support",
      ],
    ...
    },
    {
      ...
      monthlyPrice: "5%",
      annualPrice: "5%",
      description: "Advanced features for active data contributors.",
      features: [
        "Unlimited data sales",
        "Advanced consent management",
        "1.2x $DATA token multiplier",
        "Priority Lighthouse storage",
    ...
    },
    {
      ...
      features: [
        "Custom data monetization rules",
        "Dedicated consent management",
        "Custom $DATA token multipliers",
        "Private Lighthouse storage",
        "Custom AI models",
        "API integration",
      ...
      <div className="self-stretch relative flex flex-col justify-center items-center gap-2 py-0">
        <div className="flex flex-col justify-start items-center gap-4">
          <h2 className="text-center text-foreground text-4xl md:text-5xl font-semibold leading-tight md:leading-[40px]">
            Data Dividend Plans for Every User
          </h2>
          <p className="self-stretch text-center text-muted-foreground text-sm font-medium leading-tight">
            Choose a plan that fits your data monetization needs, from casual contributors to <br /> active data
            providers and enterprise organizations.
          </p>
        </div>
        <div className="pt-4">
        ...
        {pricingPlans.map((plan) => (
          ...
          >
            ...
            <div className="self-stretch flex flex-col justify-start items-start gap-4">
              ...
              >
                {plan.name === "Data Contributor" ? "Data Contributor plan includes:" : plan.name === "Data Pro" ? "Data Pro plan includes:" : "Enterprise plan includes:"}
              </div>
