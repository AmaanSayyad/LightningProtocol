...
export function BentoSection() {
  const cards = [
    {
      title: "10-Line NPM SDK",
      description: "Drop-in wrapper that transforms any commerce app into a data dividend platform with minimal integration effort.",
    ...
    },
    {
      ...
      description: "GraphSAGE and Node2Vec algorithms suggest products based on mutual connections and privacy-preserving similarity matching.",
      Component: ParallelCodingAgents,
    },
    {
      title: "ERC-20 Data Dividends",
        ...
        <div className="self-stretch py-8 md:py-14 flex flex-col justify-center items-center gap-2 z-10">
          <div className="flex flex-col justify-start items-center gap-4">
            <h2 className="w-full max-w-[655px] text-center text-foreground text-4xl md:text-6xl font-semibold leading-tight md:leading-[66px]">
              🚀 How Lightning Protocol Works
            </h2>
            <p className="w-full max-w-[600px] text-center text-muted-foreground text-lg md:text-xl font-medium leading-relaxed">
              A decentralized social layer for data incentivization with 10-line NPM SDK, EIP-712 consent management, World ID verification, and Lighthouse receipts
            </p>
          </div>
        </div>
